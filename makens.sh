...
GGML_GPP_ARGS="-fPIC -DNDEBUG -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -D_FORTIFY_SOURCE=2 -Wall -Wextra -Wpedantic -Wcast-qual -Wno-unused-function -Wno-multichar -pthread -march=native -mtune=native -march=nocona -mtune=haswell -ftree-vectorize -fstack-protector-strong -fno-plt -ffunction-sections -DGGML_USE_K_QUANTS -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable"
...
gcc -I. -O3 -std=c11 $GGML_GCC_ARGS -c -o k_quants.o inc/external/ggml/k_quants.c
...
g++ -std=c++11 -O3 -flto -fuse-linker-plugin -m64 -c -Iinc -Wno-unused-result -DCODEHAPPY_NATIVE_SDL -DALL_FONTS $SDL_COMPILE_FLAGS src/libcodehappy.cpp -o libcodehappy.o
