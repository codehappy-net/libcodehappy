...
gcc -I. -g -std=c11   -fPIC -DNDEBUG -Wall -Wextra -Wpedantic -Wcast-qual -Wdouble-promotion -Wshadow -Wstrict-prototypes -Wpointer-arith -Wmissing-prototypes -pthread -march=native -mtune=native -DGGML_USE_K_QUANTS -DGGML_USE_CUBLAS -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -D_FORTIFY_SOURCE=2 $CUDA_INC_DIRS -DNDEBUG -D_FORTIFY_SOURCE=2 -isystem /usr/local/anaconda3/include -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable  -c -o k_quants.o inc/external/ggml/k_quants.c
...
g++ -I. -I./examples -g -std=c++11 -fPIC -DNDEBUG -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -D_FORTIFY_SOURCE=2 -Wall -Wextra -Wpedantic -Wcast-qual -Wno-unused-function -Wno-multichar -pthread -march=native -mtune=native -DGGML_USE_K_QUANTS -DGGML_USE_CUBLAS $$CUDA_INC_DIRS -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable -c inc/external/ggml/sampling.cpp -o sampling.o
g++ -I. -I./examples -g -std=c++11 -fPIC -DNDEBUG -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -D_FORTIFY_SOURCE=2 -Wall -Wextra -Wpedantic -Wcast-qual -Wno-unused-function -Wno-multichar -pthread -march=native -mtune=native -DGGML_USE_K_QUANTS -DGGML_USE_CUBLAS $$CUDA_INC_DIRS -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable -c inc/external/ggml/train.cpp -o train.o
