...
#else   // !FFT_IMPLEMENTATION

#ifndef FFT_SINGLEHEADER_INCLUDED
#define FFT_SINGLEHEADER_INCLUDED

extern void fft_core(double* input_real, double* input_imag, uint64_t size, uint64_t gap, double* output_real, double* output_imag, bool forwards);
extern void normalize_fft(double* input_real, double* input_imag, uint64_t size);
extern void half_normalize_fft(double* input_real, double* input_imag, uint64_t size);
extern void fft(double* input_real, double* input_imag, uint64_t size, double* output_real, double* output_imag);
extern void ifft(double* input_real, double* input_imag, uint64_t size, double* output_real, double* output_imag);
extern void sanitize_fft(double* input_real, double* input_imag, uint64_t size);
extern void unsanitize_fft(double* input_real, double* input_imag, uint64_t size);
