...
#include "external/ggml/ggml-alloc.h"
#include "external/ggml/ggml-backend.h"
#include "external/ggml/ggml.h"

#ifdef SD_USE_CUBLAS
#include "external/ggml/ggml-cuda.h"
#endif
...
struct LoraModel {
    ...
    bool load(ggml_backend_t backend_, std::string file_path) {
        ...
        model_loader.load_tensors(on_new_tensor_cb, backend_);
