/***
	...
	Clipboard support for Windows and Linux + X11 environments.

	Originally by Arian Rezazadeh, 2020. MIT license.
...
#if defined(_WIN32) || defined(WIN32) || defined(WINDOWS) || defined(CODEHAPPY_WINDOWS)
    #include <windows.h>
